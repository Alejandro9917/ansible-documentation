...
Bienvenido a la guia de documentacion y capacitacion de Ansible.

## Objetivo

Centralizar el material de referencia, practicas y procedimientos necesarios para aprender y aplicar Ansible.

## Estado

Proyecto inicializado. El contenido de la guia se agregara en las siguientes tareas.
